...
const contactChannels = [
  ...
  {
    label: 'Read.cv',
    href: 'https://read.cv/dannymckinney',
    display: 'read.cv/dannymckinney',
  },
] as const;
...
const heroStats = [
  ...
  { value: '30+', label: 'production UI flows' },
] as const;
...
const flagshipHighlights = [
  {
    n: '01',
    title: 'Decision-focused dashboard',
    body: 'Surfaces live accessibility risk and directs teams to the highest-impact remediation work, not the loudest.',
  },
  {
    n: '02',
    title: 'Triage workspace built for volume',
    body: 'Virtualized table handling ~10k issues with filtering, grouping by page or rule, and bulk assignment — entirely keyboard operable.',
  },
  {
    n: '03',
    title: 'Real lifecycle, not reset-on-scan',
    body: "Issues flow Open → In Progress → Verified across scan cycles. Work persists; status doesn't get wiped every Monday.",
  },
  {
    n: '04',
    title: 'Audit history with diffs',
    body: 'Every scan is stored and diffable. You can answer "what regressed this sprint?" without running a new audit.',
  },
] as const;

const flagshipMetrics = [
  { value: '10k+', label: 'Issues / workspace' },
  { value: 'AAA', label: 'Contrast, primary UI' },
...
const strengths = [
  {
    title: 'Accessibility',
    description:
      'WCAG 2.2 AA as a baseline, not a goal. Keyboard, screen reader, and reduced-motion tested on every ship.',
  },
  {
    title: 'Data-heavy UI',
    description:
      'Virtualized tables, filter systems, bulk operations, optimistic updates. Built for real volumes, not demos.',
  },
  {
    title: 'Design systems',
    description:
      'Token-based theming, Radix primitives, documented a11y behavior per component. Systems that scale.',
  },
  {
    title: 'Product judgment',
    description:
      'Fintech-shaped. I read the spec, then I read the user. I push back when the design will break in production.',
  },
] as const;
          ...
          >
            <div className="mx-auto w-full max-w-6xl px-4 sm:px-6">
              <div className="flex min-w-0 flex-col gap-8">
                ...
                <div className="min-w-0">
                  <FlagshipCard
                    eyebrow="Accessibility Operations Platform · 2026"
                    title="AccessOps"
          ...
          <div className="grid gap-10 lg:grid-cols-[45%_55%] lg:gap-16">
            <div className="space-y-4">
              ...
              <p className="text-sm leading-7 text-muted-foreground sm:text-base">
                Six years shipping React and TypeScript in enterprise fintech — the kind
                of software where a broken form or an inaccessible table is a compliance
                incident, not just a bug. That shaped how I work.
              </p>
              <p className="text-sm leading-7 text-muted-foreground sm:text-base">
                I build frontend systems that don't fall over in production: accessible by
                default, keyboard-complete, tested against real data volumes, and
                documented well enough that the next engineer doesn't need to ask me what
                it does.
              </p>
              <p className="text-sm leading-7 text-muted-foreground sm:text-base">
            ...
            <div className="flex flex-col gap-8">
              <div>
                ...
                <p className="mt-5 max-w-lg text-sm leading-7 text-background/65 dark:text-muted-foreground sm:text-base">
                  Open to senior frontend roles, staff-level IC work, and short consulting
                  engagements on accessibility and data-heavy UI. Based in New York;
