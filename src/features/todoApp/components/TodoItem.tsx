                ...
                <DialogFooter>
                  ...
                  <DialogClose asChild>
                    <Button
                      ...
                      className="disabled:cursor-not-allowed disabled:border-border disabled:bg-muted/80 disabled:text-muted-foreground disabled:opacity-100 disabled:shadow-none"
                    >
                      Save
                    </Button>
                  </DialogClose>
